...
if not os.path.exists(history_path):
    ...
    try:
        ...
        # Query urls containing render.com or onrender.com and print them all
        cursor.execute("SELECT url, title, visit_count FROM urls WHERE url LIKE '%render.com%' OR url LIKE '%onrender.com%'")
        rows = cursor.fetchall()
        
        print("\n=== ALL Chrome History matching render.com / onrender.com ===")
